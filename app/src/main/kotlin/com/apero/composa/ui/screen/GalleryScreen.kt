...
import com.apero.composa.ui.components.CarouselBannerItem
import com.apero.composa.ui.components.ImageGridItem
...
fun GalleryScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(title = { Text("Composa — Carousel Demo") })
        },
    ) { padding ->
        LazyVerticalGrid(
